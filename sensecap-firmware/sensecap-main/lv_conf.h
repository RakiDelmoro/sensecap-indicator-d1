...
/*Tick interval in milliseconds for LVGL ticker*/
...
#define LV_USE_GPU_STM32_DMA2D 0
    ...
    e.g. "stm32f7xx_hal.h" or "stm32f4xx_hal.h"*/
...
#define LV_USE_GPU_NXP_PXP 0
    ...
    *   and create task for PXP interrupt (lv_gpu_nxp_pxp.c)*/
...
#define LV_USE_GPU_SDL 0
    ...
    /*Custom blend mode for GPU (0: Disable, 1: Enable)*/
...
#define LV_USE_ASSERT_STYLE         0   /*Check if the styles are properly initialized. (Fast, recommended)*/
...
/*1: Draw random colored rectangles over the redrawn areas. (slow)*/
#define LV_USE_REFR_DEBUG 0
...
#define LV_FONT_SIMSUN_16_CJK             0  /*1000 most common C radicals*/
#define LV_FONT_SIMSUN_14_CJK             0  /*1000 most common C radicals*/
#define LV_FONT_SIMSUN_14_CIK             0  /*1000 most common C radicals*/

/*Pixel perfect monospace fonts*/
#define LV_FONT_UNSCII_8  0
#define LV_FONT_UNSCII_16 0

/*Optionally declare custom fonts here like this:
 *#define LV_FONT_CUSTOM_DECLARE   LV_FONT_DECLARE(my_font_1) \
                                 LV_FONT_DECLARE(my_font_2) \
                                 LV_FONT_DECLARE(my_font_3) \
                                 ...
 *Also include them in the font list below.*/
...
#define LV_USE_FONT_SUBPX 0
    ...
    /*Set the pixel order of the display. Physical order of RGB channels. Does not matter with "normal" fonts.*/
...
/*Required alignment size for variables (in bytes)*/
#define LV_ATTRIBUTE_MEM_ALIGN_SIZE 1

/*Will be added where memories needs to be aligned (with -Os data might not be aligned to boundary by default).
 *E.g. -Wno-maybe-uninitialized -Wno-incompatible-pointer-types -Wno-unused-parameter -Wno-sign-compare*/
...
/*Prefix variables that are used in GPU accelerated operations, often these need to be DMA buffers (on ARM Cortex-M these are `__attribute__((section(".dma_buffer")))` )*/
...
/*The built-in fonts can be enabled/disabled individually, but deactivating
 *them is not recommended. New fonts can be added to the list below.*/
...
/*1: Enable file system (to open images from SD card, etc.)*/
...
#define LV_USE_FREETYPE 0
    ...
    #define LV_FREETYPE_CACHE_SIZE (16 * 1024)
        ...
        /*Some internal character calculation of FreeType will use this size. It should be >= 0.*/
 ...
 *Supports all major image formats so do not enable other image decoder if it is enabled*/
...
/*1: Enable lv_obj fragment, which is useful for fragment/tab container*/
#define LV_USE_FRAGMENT 0

/*1: Enable support for image animations*/
#define LV_USE_IMGFONT  0

/*1: Enable support for Pinyin input method*/
#define LV_USE_IME_PINYIN 0
#if LV_USE_IME_PINYIN
    /*1: Use default thesaurus*/
    #define LV_IME_PINYIN_USE_DEFAULT_DICT 1
    /*Set the maximum number of candidate panels, from 0 to 7*/
...
#define LV_USE_SDL 0
    ...
    #define LV_SDK_MOUSEWHEEL_MODE  LV_SDL_MOUSEWHEEL_MODE_ENCODER
#endif
