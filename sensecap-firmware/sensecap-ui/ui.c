...
// ==================== UI UPDATE CALLBACK ====================
// This callback is registered in Rust and called when MQTT data arrives
// It updates the UI from the Rust backend
void ui_update_callback(int water_level, int bright_state, int relax_state)
{
    printf("[UI] Callback received: water=%d, bright=%d, relax=%d\n", 
